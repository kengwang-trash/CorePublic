...
<body>
			...
			<div class="mdui-container" id="LoginTab">
				...
				<form id="login">
					<div class="mdui-textfield mdui-textfield-floating-label">
						<div class="mdui-textfield-label">用户名</div><input type="text" name="username" id="username" class="mdui-textfield-input">
					</div>
					<div class="mdui-textfield mdui-textfield-floating-label">
						<div class="mdui-textfield-label">密码</div><input type="password" name="password" id="password" class="mdui-textfield-input">
					</div>
					<div class="mdui-textfield mdui-textfield-floating-label">
						<div class="mdui-textfield-label">验证码</div><input type="text" name="captcha" id="captcha" class="mdui-textfield-input">
				...
				<br><br>
				<button class="mdui-btn mdui-ripple" onclick="ChangeTab('reg');" mdui-dialog-close>还没账号?注册...</button>
			</div>
		</div>
	</div>
	<!--Reg-->
	<div class="mdui-dialog" id="RegDialog">
		<div id="LoginProgress" class="mdui-hidden mdui-progress">
			<div class="mdui-progress-indeterminate">
			</div>
		</div>
		<div class="mdui-dialog-content">
			<div class="mdui-container" id="RegTab">
				...
				<form id="reg">
					<div class="mdui-textfield mdui-textfield-floating-label">
						<div class="mdui-textfield-label">用户名</div><input type="text" name="username" class="mdui-textfield-input">
					</div>
					<div class="mdui-textfield mdui-textfield-floating-label">
						<div class="mdui-textfield-label">昵称</div><input type="text" name="nickname" class="mdui-textfield-input">
					</div>
					<div class="mdui-textfield mdui-textfield-floating-label">
						<div class="mdui-textfield-label">密码</div><input type="password" name="password" class="mdui-textfield-input">
					</div>
					<div class="mdui-textfield mdui-textfield-floating-label">
						<div class="mdui-textfield-label">邮箱</div><input type="email" name="email" class="mdui-textfield-input">
					</div>
					<div class="mdui-textfield mdui-textfield-floating-label">
						<div class="mdui-textfield-label">验证码</div><input type="text" name="captcha" id="captcha" class="mdui-textfield-input">
				...
				<br><br>
				<button class="mdui-btn mdui-ripple" onclick="ChangeTab('login');" mdui-dialog-close>已有账号?登录...</button>
			</div>
		</div>
	</div>
	<?php
	...
	<div class="mdui-dialog" id="ProtocolDialog">
		...
		<div class="mdui-dialog-content">
			<div class="mdui-typo">
				...
				4. 在发表言论(包括但不限于 文件名、 文件内容、 文件简介、 评论) 以及文件时请注意遵守当地法律以及 "中华人民共和国"法律(包括但不限于《 中华人民共和国宪法》),任何违法行为都将受到法律的制裁,本项目人员将会尽力配合执法人员对违法行为追究并冻结其账号!<br>
				...
				7. 如果有人违反了上述内容或者其他内容,责任将由当事人负责,一切与本项目或本项目开发维护人员无关,本项目人员将会协助执法人员执法。<br>
	...
	<div id="header">&nbsp;</div>
	<!--Header End-->
	<?php if ($title != '首页' && !$NeedMD) {
		echo '<div class="mdui-container" id="BodyContents">';
	} elseif ($NeedMD) {
		echo '<div id="BodyContents">';
	} else {
